...
namespace TechCommerce.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    // Step 1: Create a new Cart instance
                    var cart = new Cart();
                    _context.Carts.Add(cart);
                    await _context.SaveChangesAsync(); // Save changes to get the Cart Id

                    // Step 2: Create user and set properties
                    var user = CreateUser();
                    user.Firstname = Input.FirstName;
                    user.CartId = cart.Id; // Set the CartId for the user
